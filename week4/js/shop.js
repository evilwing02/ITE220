var shop = {
	...
	var productsText ="";
 	...
 	productsText += "<li class='list-group-item'><span class='badge'>S"+this.price[0]+"</span>" + this.products[0]+"</li>";
 	productsText += "<li class='list-group-item'><span class='badge'>S"+this.price[1]+"</span>" + this.products[1]+"</li>";
 	productsText += "<li class='list-group-item'><span class='badge'>S"+this.price[2]+"</span>" + this.products[2]+"</li>";
	productsText += "<li class='list-group-item'><span class='badge'>S"+this.price[3]+"</span>" + this.products[3]+"</li>";	
	
	productsElement.innerHTML = productsText;
	},
	calculateTotalPrice: function(){
		return (this.price[0] +this.price[1] + this.price[2] +this.price[3]) *0.75;
	},

	displayTotalPrice: function(){
		this.totalPrice= this.calculateTotalPrice();
		var totlePriceElement = document.getElementById("total");
